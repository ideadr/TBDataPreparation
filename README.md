...
| SW version    | Path          |  Comments     |
| ------------- | ------------- | ------------- |
| v1.3.5        | /eos/user/i/ideadr/TB2021_Desy/DESYDATA/v1.3.5/ | Data produced with v1.3.5: new full calibration using new equilization for SiPM.  Data produced from merged ntuple as copied from v1.3.2 . Only reconNtuple/ files are stored. Produced by Gabriella on 8.6.2022 |
